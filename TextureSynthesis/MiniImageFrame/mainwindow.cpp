...
void MainWindow::CreateActions()
{
	...
	action_random_synthesis_ = new QAction(tr("Random"), this);
	action_random_synthesis_->setStatusTip(tr("Texture synthesis with random placement"));
	connect(action_random_synthesis_, SIGNAL(triggered()), imagewidget_, SLOT(Choose_Random()));

	action_entire_synthesis_ = new QAction(tr("Entire patch"), this);
	action_entire_synthesis_->setStatusTip(tr("Texture synthesis with entire patch placement"));
	connect(action_entire_synthesis_, SIGNAL(triggered()), imagewidget_, SLOT(Choose_Entire()));

	action_subpatch_synthesis_ = new QAction(tr("Subpatch"), this);
	action_subpatch_synthesis_->setStatusTip(tr("Texture synthesis with subpatch placement"));
	connect(action_subpatch_synthesis_, SIGNAL(triggered()), imagewidget_, SLOT(Choose_Subpatch()));

	action_is_draw_seams_ = new QAction(tr("Show Seams"), this);
	action_is_draw_seams_->setStatusTip(tr("Draw seams"));
	connect(action_is_draw_seams_, SIGNAL(triggered()), imagewidget_, SLOT(Is_DrawSeams()));
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_random_synthesis_);
	menu_edit_->addAction(action_entire_synthesis_);
	menu_edit_->addAction(action_subpatch_synthesis_);
	menu_edit_->addAction(action_is_draw_seams_);
}
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_random_synthesis_);
	toolbar_file_->addAction(action_entire_synthesis_);
	toolbar_file_->addAction(action_subpatch_synthesis_);
	toolbar_file_->addAction(action_is_draw_seams_);
}
